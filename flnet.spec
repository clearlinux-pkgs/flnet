...
Version  : 7.4.0
Release  : 8
URL      : https://sourceforge.net/projects/fldigi/files/flnet/flnet-7.4.0.tar.gz
Source0  : https://sourceforge.net/projects/fldigi/files/flnet/flnet-7.4.0.tar.gz
...
%prep
%setup -q -n flnet-7.4.0
cd %{_builddir}/flnet-7.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617212878
...
cp %{_builddir}/flnet-7.4.0/COPYING %{buildroot}/usr/share/package-licenses/flnet/b47456e2c1f38c40346ff00db976a2badf36b5e3
cp %{_builddir}/flnet-7.4.0/src/mbedtls/LICENSE %{buildroot}/usr/share/package-licenses/flnet/941df1b3181ce17b8441e0e3775808f266a80fc8
%make_install
